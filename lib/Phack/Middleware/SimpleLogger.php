...
class Phack_Middleware_SimpleLogger extends Phack_Middleware
{
    ...
    public function call(&$environ)
    {
        ...
        $environ['phsgix.logger'] = new Phack_Middleware_SimpleLogger_Logger($environ['phsgi.errors'], $min);
...
Phack_Middleware_SimpleLogger::_classinit();

class Phack_Middleware_SimpleLogger_Logger
{
    protected $io;
    protected $min;
    ...
    {
        if (Phack_Middleware_SimpleLogger::$LEVEL_NUMBERS[$level] >= $this->min) {

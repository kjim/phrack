<?php
require_once('Phack/HTTP/Headers.php');
require_once('Phack/Util.php');

class Phack_Response
{
    protected $status;
    protected $headers;
    protected $body;
    ...
    {
        $this->headers = new Phack_HTTP_Headers($headers);
    }
    ...
    public function finalize()
    {
        ...
        return array(Phack_Util::statusText($this->status), $this->headers->items(), $this->_body());
    }

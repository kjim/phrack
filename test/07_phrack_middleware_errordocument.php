...
require_once('Phrack/Middleware/ErrorDocument.php');
...
function testNoSubrequest($t)
{
    ...
    $app = 'notfound';
    $app = Phrack_Middleware_ErrorDocument::wrap($app, array(404 => $file404));

    $environ = array();
    list($status, $_, $body) = Phrack_Util::callApp($app, $environ);
    ...
    $app = 'internalerror';
    $app = Phrack_Middleware_ErrorDocument::wrap($app, array(500 => $file500));
...
function testUseSubrequest($t)
{
    ...
    $app = 'notfound';
    $app = Phrack_Middleware_ErrorDocument::wrap($app, array(404 => $path404, 'subrequest' => true));
    ...
    $app = 'internalerror';
    $app = Phrack_Middleware_ErrorDocument::wrap($app, array(500 => $path500, 'subrequest' => true));
